...
Real-time collaboration via Yjs and Hocuspocus. Two-browser sync of board state, awareness/presence, and Yjs document persistence to PostgreSQL.

---

<!-- Promoted from openspec/changes/first-milestone-vertical-slice/specs/collab/spec.md -->
